...
inline bool CreateCircle(PhysicsBody* body, vec2 pos, float radius ,vec2 vel, Material material)
{
...
inline bool CreateAABB(PhysicsBody* body, vec2 pos, vec2 dim, vec2 vel, Material material )
{
	//body = new PhysicsBody();
	if (body == nullptr) return false;
...
inline bool CreatePolygon(PhysicsBody* body, vec2 pos, float radius, float numberPoints, vec2 vel, Material material)
{
	//body = new PhysicsBody();
